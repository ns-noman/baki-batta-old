                            ...
                            <thead>
                               ...
                               if ($due_total!= 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $customer->customer_organization;?></td>  
                                    <td><?php echo $customer->customer_mobile;?></td>
                                    <td align="right"><?php echo number_format($sales_total, 2, '.', ',') ;
                                        ;?>
                                    </td>
                                    <td align="right"><?php echo number_format($paid_total, 2, '.', ',');
                                        ;?>
                                    </td>
                                    <td align="right"><?php echo number_format($due_total, 2, '.', ',');
                                        ;?>
                                    </td>     
                                </tr>
                            <?php } } ?>
                                <tr style="font-weight:bold; background-color: #dfdfdf;">
                                    ...
                                    <td align="right"><?php echo number_format($bill_total, 2, '.', ',');?></td>  
                                    <td align="right"><?php echo number_format($paid_sum, 2, '.', ',');?></td>  
