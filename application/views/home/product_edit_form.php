        ...
        <div class="card-body">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="vat" class="col-sm-4 col-form-label">Discount</label>
                            <div class="col-sm-7">
                                <input type="number" id="discount" name="discount"class="form-control" placeholder="Discount%" value="<?php echo $update_product->product_discount_per; ?>" step="0.01">
                            </div>
                            <div class="col-sm-1"> <i class="text-success">%</i></div>
                        </div>
                    </div>
