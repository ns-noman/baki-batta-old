        ...
        <div class="card-body table-responsive" id="printableArea">
          ...
          <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-3 col-sm-3">
                                    <?php if($payment_info->customer_payment_no){ ?><img src="<?php echo base_url().'barcode-gen/'.$payment_info->customer_payment_no; ?>"> <br>
                                     <label class="form-label">Receipt#: <?php echo $payment_info->customer_payment_no; ?></label>
                                <?php } ?>
                                   
                                    <label class="form-label">Payment Date: <?php echo date("d/m/Y", strtotime($payment_info->customer_payment_date)); ?></label>
                            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tfoot>
                        ...
                        <tr>
                         ...
                         <?php if($payment_info->customer_payment_detail){ ?>
                        <tr>
                            <td colspan="4">
                               <b>Note:</b> <?php echo $payment_info->customer_payment_detail; ?>
                            </td>
                        </tr>
                    <?php } ?>
