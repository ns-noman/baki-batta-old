    ...
    <section class="content">
      <div class="card">
        <div class="card-body table-responsive">
          ...
          <input type="text" class="form-control" name="product_search" id="product_search" placeholder="Barcode, SKU, Name, or Model">
          <div class="input-group-append">
            ...
            <tr>
              ...
              <?php } ?>
               ...
               <a class="btn btn-info btn-xs" href="<?php echo base_url() . "duplicate-product/" . $product->product_id; ?>">
                  Duplicate
                </a>
            </td>
                        </tr>
