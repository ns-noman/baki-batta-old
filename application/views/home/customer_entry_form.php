        ...
        <form class="form-horizontal" action="<?php echo base_url() . "update-customer/" . $edit_info->customer_id; ?>" method="post" enctype="multipart/form-data"  role="form">
            <div class="card-body">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="customer_crl" class="col-sm-4 col-form-label">Credit Limit Amount</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="customer_crl" id="customer_crl" value="<?php echo $edit_info->customer_cr_amount; ?>" step="0.01">
                                <span class="text-red"><?php echo form_error('customer_crl'); ?></span>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="col-sm-6">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="customer_crl" class="col-sm-4 col-form-label">Credit Limit Amount</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="customer_crl" id="customer_crl" step="0.01">
                                <span class="text-red"><?php echo form_error('customer_crl'); ?></span>
                            </div>
                        </div>
                    </div>
