...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-left">
         ...
         <a href="<?php echo base_url().'sales-ledger'; ?>" class="dropdown-item">
          ...
          <div class="dropdown-divider"></div>
          <?php } ?>
          <?php  if($this->session->userdata('user_type') == "Client" or in_array('Top Selling Products', $privilege_set)){ ?>
          <a href="<?php echo base_url().'top-selling-product-report'; ?>" class="dropdown-item">
           Top Selling Products
          </a>
          <div class="dropdown-divider"></div>
          <?php } ?>
          <?php  if($this->session->userdata('user_type') == "Client" or in_array('Idle Products', $privilege_set)){ ?>
          <a href="<?php echo base_url().'idle-product-report'; ?>" class="dropdown-item">
           Idle Products
          </a>
          <div class="dropdown-divider"></div>
          <?php } ?>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
          ...
          <div class="dropdown-divider"></div>
          <?php } ?> 
          <?php  if($this->session->userdata('user_type') == "Client" or in_array('Product Detail View', $privilege_set)){ ?>
          <a href="<?php echo base_url().'search-product'; ?>" class="dropdown-item">
          Product Detail View
          </a>
          <div class="dropdown-divider"></div>
          <?php } ?> 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link">
      <span class="brand-text font-weight-light">BakiBatta</span>
    </a>
        ...
        <?php } ?>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <?php } ?> -->
                <?php  if($this->session->userdata('user_type') == "Client" or in_array('Top Selling Products', $privilege_set)){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'top-selling-product-report'; ?>" class="nav-link">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
               ...
               <?php  if($this->session->userdata('user_type') == "Client" or in_array('Idle Products', $privilege_set)){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'idle-product-report'; ?>" class="nav-link">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
                  <p>Idle Products</p>
                </a>
              </li>
          ...
          <?php  if($this->session->userdata('user_type') == "Client" or in_array('Product', $privilege_set)){ ?>
            ...
            <ul class="nav nav-treeview">
              ...
              <?php  if($this->session->userdata('user_type') == "Client" or in_array('Product Detail View', $privilege_set)){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'search-product'; ?>" class="nav-link">
                  <i class="far fa-arrow-alt-circle-right nav-icon"></i>
          ...
          <?php } ?>
             <?php  if($this->session->userdata('user_type') == "Client" or in_array('Re-Set Password', $privilege_set)){ ?>
              <li class="nav-item">
  ...
  <footer class="main-footer no-print">
    <strong>Developed by <a href="https://bakibatta.com" target="_blank">BakiBatta</a></strong>
...
<script type="text/javascript">
   ...
   $( "#customer_name, #customer_mobile" ).autocomplete({
      ...
      select: function (event, ui) {
        ...
        $('#customer_cr').val(ui.item.cr); // save selected id to input
        $('#customer_due').val(ui.item.due); // save selected id to input
...
function salescalculation() {
    ...
    var sales_temp_total = (mrp_temp * sales_qty_temp)+sales_vat_temp- sales_discount_temp;
...
for ( var i = 0; i < product.length; i++ ){
        ...
        sales_value = (mrp[i].value * qty[i].value)+sales_vat-sdiscount[i].value;
        sum += mrp[i].value * qty[i].value;
        document.getElementsByName("total_amount[]")[i].value = sales_value.toFixed(2);
        discounttotal += parseFloat(sdiscount[i].value);
        vattotal += sales_vat;
...
$("#sales_form").submit(function(e) {
      ...
      var customer_cr = $('#customer_cr').val();
      ...
      var product = document.getElementsByName("product_name[]");
        ...
        if (parseFloat(sales_due) > parseFloat(customer_cr) || parseFloat(customer_due) > parseFloat(customer_cr)) {
          alert ('Customer Credit Limit exceed.')
  ...
  function productdetailBarcode() {
    if (txt != $("#product_code").val()) {
        txt = $("#product_code").val();
                ...
                type : 'POST',
                data : {txt : txt},
                url : '<?php echo site_url('search-product-code-data'); ?>',
                success : function(result){
                    $('#printableArea').html(result);
                     $("#product_code").focus();
             }
...
$(document).ready(function(){
 ...
 function load_report_data(query)
 {
  $.ajax({
 ...
 $("#product_search").on("change paste keyup", function() {
  var search = $(this).val();

  if(search != '')
  {
   load_report_data(search);
  }
  else
  {
   load_report_data();
