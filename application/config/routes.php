...
$route['client-list'] = 'admin/client_list';
...
$route['duplicate-product/(:any)'] = 'client/duplicate_product_id/$1';
$route['search-product'] = 'client/search_product_detail';
$route['search-product-code-data'] = 'client/search_product_detail_data';
...
//report
 ...
 $route['top-selling-product-report'] = 'client/top_selling_product_report';
 $route['idle-product-report'] = 'client/idle_product_report';
...
$route['product-search'] = 'client/product_search';

$route['barcode-gen/(:any)'] = 'client/bar_gen/$1';
